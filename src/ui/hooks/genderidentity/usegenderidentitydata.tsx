...
const UseGenderIndentityData = (): DataReturn => {
   ...
   return useGenericData<Catalogues>({
     ...
     prefix: "identidadgenero",
     autoFetch: true,
     // persistKey: "departments-persist",
     hooks: {
       onError: (msg) => console.error("[UseGenderIndentityData]", msg),
     },
   });
};

export default UseGenderIndentityData;
