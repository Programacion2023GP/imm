...
const UseForeignTransportation = (): DataReturn => {
   ...
   return useGenericData<Catalogues>({
     ...
     prefix: "transporteforaneo",
     autoFetch: true,
     // persistKey: "departments-persist",
     hooks: {
       onError: (msg) => console.error("[UseForeignTransportation]", msg),
     },
   });
};

export default UseForeignTransportation;
