...
const UseSexualOrientationData = (): DataReturn => {
   ...
   return useGenericData<Catalogues>({
     ...
     prefix: "orientacionsexual",
     autoFetch: true,
     // persistKey: "departments-persist",
     hooks: {
       onError: (msg) => console.error("[UseSexualOrientationData]", msg),
     },
   });
};

export default UseSexualOrientationData;
