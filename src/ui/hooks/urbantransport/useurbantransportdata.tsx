...
const UseUrbanTransportation = (): DataReturn => {
   ...
   return useGenericData<Catalogues>({
     ...
     prefix: "transporteurbano",
     autoFetch: true,
     // persistKey: "departments-persist",
     hooks: {
       onError: (msg) => console.error("[UseUrbanTransportation]", msg),
     },
   });
};

export default UseUrbanTransportation;
