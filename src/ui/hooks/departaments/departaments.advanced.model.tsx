...
export const departamentBaseConfig = ConfigCrud<DepartamentForm, DepartamentTable>()
  .fields({
  ...
  .select({
    status: {
      ...
      label: "Estado",
      validation: ({ yup }) => yup.string().required("El estado es requerido"),
    },
    manager_id: {
      keyId: "id",
      keyLabel: "name",
...
export const departamentAdvancedConfig: AdvancedCrudConfig<DepartamentForm, DepartamentTable> = {
  // Permisos (RBAC)
  permissions: {
...
import { useGenericData, GenericDataConfig } from "../../../hooks/usegenericdata";
