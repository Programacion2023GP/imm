...
const UseAssociatedviolencesData = (): DataReturn => {
   ...
   return useGenericData<Catalogues>({
     ...
     prefix: "violenciaasociada",
     autoFetch: true,
     // persistKey: "departments-persist",
     hooks: {
       onError: (msg) => console.error("[UseAssociatedviolencesData]", msg),
     },
   });
};

export default UseAssociatedviolencesData;
