...
const UseIssuesAddressedData = (): DataReturn => {
   ...
   return useGenericData<Catalogues>({
     ...
     prefix: "problematicaabordada",
     autoFetch: true,
     // persistKey: "departments-persist",
     hooks: {
       onError: (msg) => console.error("[UseIssuesAddressedData]", msg),
     },
   });
};

export default UseIssuesAddressedData;
