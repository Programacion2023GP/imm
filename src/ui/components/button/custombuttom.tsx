...
const PALETTE = {
  ...
  ruby: {
    ...
    dark: "#7a1a35",
    light: "#fceef2",
    border: "rgba(155,34,66,0.22)",
    glow: "rgba(155,34,66,0.20)",
    text: "#fff",
  },
  crimson: {
    base: "#dc2626",
  ...
  slate: {
    ...
    dark: "#2d2d3e",
    light: "#f2f2f6",
    border: "rgba(61,61,82,0.22)",
    glow: "rgba(61,61,82,0.18)",
    text: "#fff",
  },
  gray: {
    base: "#6b7280",
  ...
  warmGray: {
    ...
    dark: "#6b5e4e",
    light: "#fefaf5",
    border: "rgba(139,126,110,0.22)",
    glow: "rgba(139,126,110,0.18)",
    text: "#fff",
  },
...
/* ══════════════════════════════════════════════════════════════
   SIZE SCALE - MODIFICADO PARA SOPORTAR RADIO NORMAL Y REDONDO
══════════════════════════════════════════════════════════════ */
...
export type ButtonProps = {
  ...
  // 👇 NUEVAS PROPS PARA CONTROLAR LA FORMA
  rounded?: boolean; // true = redondo (border-radius alto), false = bordes cuadrados suaves
  borderRadius?: number; // opcional: valor personalizado (anula rounded)
...
/* ══════════════════════════════════════════════════════════════
   VARIANT STYLE BUILDER - MODIFICADO PARA SOPORTAR rounded/borderRadius
══════════════════════════════════════════════════════════════ */
...
function buildStyle(
  ...
  // Determinar el border-radius final
  let radius: number;
  if (customRadius !== undefined) {
    radius = customRadius;
  } else if (rounded) {
    radius = s.radiusRounded;
  } else {
    radius = s.radiusNormal;
  }
...
const BadgeEl: React.FC<BadgeProps> = ({
  badge,
  badgeColor,
  badgeVariant,
  badgePosition,
  ...
  return (
    ...
    >
      <circle
        ...
        cy="10"
        r="7"
        stroke={onSolid ? "rgba(255,255,255,0.25)" : "rgba(0,0,0,0.1)"}
        strokeWidth="2.5"
      />
      <path
        d="M10 3a7 7 0 0 1 7 7"
        stroke={onSolid ? "#fff" : "currentColor"}
        strokeWidth="2.5"
        strokeLinecap="round"
      />
    </svg>
...
/* ══════════════════════════════════════════════════════════════
   MAIN BUTTON - CON rounded Y borderRadius
══════════════════════════════════════════════════════════════ */
...
export const CustomButton: React.FC<ButtonProps> = ({
  ...
  const hasBadge =
    showBadge && badge !== undefined && badge !== null && badge !== false;
  ...
  const updateBadgePosition = () => {
    ...
    const badgeSize =
      badgeVariant === "dot" || badgeVariant === "pulse" ? s.dotW : s.badgeH;
  ...
  const renderBadgeDirect = () => {
    ...
    const offset =
      badgeVariant === "dot" || badgeVariant === "pulse"
        ? -s.dotW / 2
        : -s.badgeH / 2;
