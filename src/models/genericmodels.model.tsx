   ...
   const api = {
      ...
      >(config: {
         ...
         const methods = {
            ...
            file: (
               newConfig: Partial<
                  Record<TFile[number], FileUploadConfig<TForm>>
               >,
            ) => {
            ...
            color: (
               newConfig: Partial<
                  Record<TColor[number], ColorPickerConfig<TForm>>
               >,
            ) => {
            ...
            password: (
               newConfig: Partial<
                  Record<TPassword[number], PasswordConfig<TForm>>
               >,
            ) => {
            ...
            textarea: (
               newConfig: Partial<
                  Record<TTextarea[number], TextareaConfig<TForm>>
               >,
            ) => {
            ...
            checkbox: (
               newConfig: Partial<
                  Record<TCheckbox[number], CheckboxConfig<TForm>>
               >,
            ) => {
